...
//    private final long transactionSequence;
    ...
    public SpanBoResult(SpanBo spanBo) {
        this.version = spanBo.getRawVersion();
        this.agentId = spanBo.getAgentId();
        this.applicationId = spanBo.getApplicationId();
        this.agentStartTime = spanBo.getAgentStartTime();
        this.transactionIdCreated = spanBo.getTransactionId().getAgentId()+"^"+spanBo.getTransactionId().getAgentStartTime()+"^"+spanBo.getTransactionId().getTransactionSequence();
        this.spanId = spanBo.getSpanId();
        this.parentSpanId = spanBo.getParentSpanId();
        this.parentApplicationId = spanBo.getParentApplicationId();
        this.parentApplicationServiceType = spanBo.getParentApplicationServiceType();
        this.startTime = spanBo.getStartTime();
        this.elapsed = spanBo.getElapsed();
        this.rpc = spanBo.getRpc();
        this.serviceType = spanBo.getServiceType();
        this.endPoint = spanBo.getEndPoint();
        this.apiId = spanBo.getApiId();
        this.annotationBoList = spanBo.getAnnotationBoList();
        this.flag = spanBo.getFlag();
        this.errCode = spanBo.getErrCode();
        this.spanChunkBoList = spanBo.getSpanChunkBoList();
        this.collectorAcceptTime = spanBo.getCollectorAcceptTime();
        this.hasException = spanBo.hasException();
        this.exceptionId = spanBo.getExceptionId();
        this.exceptionMessage = spanBo.getExceptionMessage();
        this.exceptionClass = spanBo.getExceptionClass();
        this.applicationServiceType = spanBo.getApplicationServiceType();
        this.acceptorHost = spanBo.getAcceptorHost();
        this.remoteAddr = spanBo.getRemoteAddr();
        this.loggingTransactionInfo = spanBo.getLoggingTransactionInfo();
    }
...
//        this.transactionId = transactionId;
    ...
    public String getTransactionIdCreated() {
        return this.transactionIdCreated;
    }
    ...
    public String toString() {
        ...
        sb.append(", transactionId=").append(transactionIdCreated);
