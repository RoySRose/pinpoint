...
package com.navercorp.pinpoint.api.config;
 ...
 * @author Roy Kim
 */
public class PinpointApiWebApplicationInitializer implements WebApplicationInitializer {

    public PinpointApiWebApplicationInitializer() {
    }
